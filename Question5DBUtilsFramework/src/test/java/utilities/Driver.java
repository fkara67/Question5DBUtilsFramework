...
public class Driver {
    public static final Duration IMPLICIT_WAIT_TIME_IN_SECONDS = Duration.ofSeconds(20);
    public static final Duration IMPLICIT_PAGE_LOAD_TIMEOUT = Duration.ofSeconds(20);
